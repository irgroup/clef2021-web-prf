...
def main():
    ...
    dri_er = {
        'c18_d_t': {
            'er': rpl_eval.er(runs_rpl['uwmrgx_c18_d_t']['scores'], runs_rpl['uwmrg_c18_d_t']['scores']),
            'dri': rpl_eval.dri(runs_rpl['uwmrgx_c18_d_t']['scores'], runs_rpl['uwmrg_c18_d_t']['scores']),
            'type': 't'
        },
        'c18_d_td': {
            'er': rpl_eval.er(runs_rpl['uwmrgx_c18_d_td']['scores'], runs_rpl['uwmrg_c18_d_td']['scores']),
            'dri': rpl_eval.dri(runs_rpl['uwmrgx_c18_d_td']['scores'], runs_rpl['uwmrg_c18_d_td']['scores']),
            'type': 'td'
        },
        'c17_d_t': {
            'er': rpl_eval.er(runs_rpl['uwmrgx_c17_d_t']['scores'], runs_rpl['uwmrg_c17_d_t']['scores']),
            'dri': rpl_eval.dri(runs_rpl['uwmrgx_c17_d_t']['scores'], runs_rpl['uwmrg_c17_d_t']['scores']),
            'type': 't'
        },
        'c17_d_td': {
            'er': rpl_eval.er(runs_rpl['uwmrgx_c17_d_td']['scores'], runs_rpl['uwmrg_c17_d_td']['scores']),
            'dri': rpl_eval.dri(runs_rpl['uwmrgx_c17_d_td']['scores'], runs_rpl['uwmrg_c17_d_td']['scores']),
            'type': 'td'
        },
        'r5_d_t': {
            'er': rpl_eval.er(runs_rpl['uwmrgx_r5_d_t']['scores'], runs_rpl['uwmrg_r5_d_t']['scores']),
            'dri': rpl_eval.dri(runs_rpl['uwmrgx_r5_d_t']['scores'], runs_rpl['uwmrg_r5_d_t']['scores']),
            'type': 't'
        },
        'r5_d_td': {
            'er': rpl_eval.er(runs_rpl['uwmrgx_r5_d_td']['scores'], runs_rpl['uwmrg_r5_d_td']['scores']),
            'dri': rpl_eval.dri(runs_rpl['uwmrgx_r5_d_td']['scores'], runs_rpl['uwmrg_r5_d_td']['scores']),
            'type': 'td'
        },
        'r4_d_t': {
            'er': rpl_eval.er(runs_rpl['uwmrgx_r4_d_t']['scores'], runs_rpl['uwmrg_r4_d_t']['scores']),
            'dri': rpl_eval.dri(runs_rpl['uwmrgx_r4_d_t']['scores'], runs_rpl['uwmrg_r4_d_t']['scores']),
            'type': 't'
        },
        'r4_d_td': {
            'er': rpl_eval.er(runs_rpl['uwmrgx_r4_d_td']['scores'], runs_rpl['uwmrg_r4_d_td']['scores']),
            'dri': rpl_eval.dri(runs_rpl['uwmrgx_r4_d_td']['scores'], runs_rpl['uwmrg_r4_d_td']['scores']),
            'type': 'td'
        }
    }
    ...
    for measure, mk in zip(measures, marker_color):
        ax1.plot([dri_er[r]['er'][measure] for r in ['c18_d_td', 'c17_d_td', 'r5_d_td', 'r4_d_td']],
                 [dri_er[r]['dri'][measure] for r in ['c18_d_td', 'c17_d_td', 'r5_d_td', 'r4_d_td']],
                 marker=mk[0],
                 color='g',
                 linestyle='None',
                 label=measure)
    ...
    for measure, mk in zip(measures, marker_color):
        ax1.plot([dri_er[r]['er'][measure] for r in ['c18_d_t', 'c17_d_t', 'r5_d_t', 'r4_d_t']],
                 [dri_er[r]['dri'][measure] for r in ['c18_d_t', 'c17_d_t', 'r5_d_t', 'r4_d_t']],
                 marker=mk[0],
                 color='b',
                 linestyle='None',
                 label=measure)
    ...
    plt.title('Query variations with DuckDuckGo')
    plt.savefig('./data/plots/dri_vs_er_ddg.pdf', format='pdf', bbox_inches='tight')
    plt.show()
