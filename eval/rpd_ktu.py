...
def main():
    ...
    ax.set_ylabel(r"Kendall's $\tau$ Union")
    ax.get_figure().savefig('./data/plots/rpd_b_ktu.pdf', format='pdf', bbox_inches='tight', loc='upper right')
    plt.show()
    ...
    ax.set_xlabel('Cut-off values')
    ax.set_ylabel(r"Kendall's $\tau$ Union")
    ax.get_figure().savefig('./data/plots/rpd_a_ktu.pdf', format='pdf', bbox_inches='tight', loc='upper right')
    plt.show()
